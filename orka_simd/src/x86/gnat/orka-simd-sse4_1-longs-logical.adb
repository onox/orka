...
package body Orka.SIMD.SSE4_1.Longs.Logical is
   ...
   function Test_All_Zero (Elements, Mask : m128l) return Boolean is
     (Test_All_Zero (Elements, Mask) = 1);

   function Test_All_Ones (Elements, Mask : m128l) return Boolean is
     (Test_All_Ones (Elements, Mask) = 1);

   function Test_Mix_Ones_Zeros (Elements, Mask : m128l) return Boolean is
