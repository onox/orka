...
package body GL.Objects.Framebuffers is
   ...
   begin
      return API.Check_Named_Framebuffer_Status.Ref (Object.Reference.GL_Id, Target.Kind);
   end Status;
   ...
   begin
      API.Named_Framebuffer_Draw_Buffers.Ref (Object.Reference.GL_Id, List'Length, List);
   end Set_Draw_Buffers;

   procedure Set_Read_Buffer (Object : Framebuffer; Selector : Buffers.Color_Buffer_Selector) is
   begin
      API.Named_Framebuffer_Read_Buffer.Ref (Object.Reference.GL_Id, Selector);
   end Set_Read_Buffer;
   ...
   begin
      API.Named_Framebuffer_Texture.Ref (Object.Reference.GL_Id, Attachment,
   ...
   procedure Attach_Texture_Layer
     (Object     : Framebuffer;
      ...
      Layer      : Natural) is
   begin
      API.Named_Framebuffer_Texture_Layer.Ref (Object.Reference.GL_Id, Attachment,
                                           Texture.Raw_Id, Level, Int (Layer));
   end Attach_Texture_Layer;

   procedure Detach (Object : Framebuffer; Attachment : Attachment_Point) is
   begin
      API.Named_Framebuffer_Texture.Ref (Object.Reference.GL_Id, Attachment, 0, 0);
   end Detach;
   ...
   begin
      API.Invalidate_Named_Framebuffer_Data.Ref
   ...
   begin
      API.Invalidate_Named_Framebuffer_Sub_Data.Ref
   ...
   begin
      API.Invalidate_Named_Framebuffer_Data_Default.Ref
        (Object.Reference.GL_Id, Attachments'Length, Attachments);
   end Invalidate_Data;
   ...
   procedure Invalidate_Sub_Data
     (Object        : Framebuffer;
      ...
      Width, Height : Size) is
   begin
      API.Invalidate_Named_Framebuffer_Sub_Data_Default.Ref
        (Object.Reference.GL_Id, Attachments'Length, Attachments, X, Y, Width, Height);
   end Invalidate_Sub_Data;
   ...
   begin
      API.Blit_Named_Framebuffer.Ref (Read_Object.Reference.GL_Id,
   ...
   function Max_Framebuffer_Width return Size is
      Ret : Size := 16_384;
   begin
      API.Get_Size.Ref (Enums.Getter.Max_Framebuffer_Width, Ret);
      return Ret;
   ...
   function Max_Framebuffer_Height return Size is
      Ret : Size := 16_384;
   begin
      API.Get_Size.Ref (Enums.Getter.Max_Framebuffer_Height, Ret);
      return Ret;
   ...
   function Max_Framebuffer_Layers return Size is
      Ret : Size := 2_048;
   begin
      API.Get_Size.Ref (Enums.Getter.Max_Framebuffer_Layers, Ret);
      return Ret;
   ...
   function Max_Framebuffer_Samples return Size is
      Ret : Size := 4;
   begin
      API.Get_Size.Ref (Enums.Getter.Max_Framebuffer_Samples, Ret);
      return Ret;
   end Max_Framebuffer_Samples;

   procedure Set_Default_Fixed_Sample_Locations (Object : Framebuffer; Value : Boolean) is
   begin
      API.Named_Framebuffer_Parameter_Bool.Ref (Object.Reference.GL_Id,
   ...
   procedure Initialize_Id (Object : in out Framebuffer) is
      New_Id : UInt := 0;
   begin
      API.Create_Framebuffers.Ref (1, New_Id);
   ...
   begin
      API.Bind_Framebuffer.Ref (Target.Kind, Object.Reference.GL_Id);
   end Bind;
   ...
   begin
      case Format_Type is
         when Float_Or_Normalized_Type =>
            API.Clear_Named_Framebuffer_Color_Real.Ref
              (Object.Reference.GL_Id, Enums.Color_Buffer, Index, Value);
         when Int_Type =>
            API.Clear_Named_Framebuffer_Color_Signed_Int.Ref
              (Object.Reference.GL_Id, Enums.Color_Buffer, Index, Value);
         when Unsigned_Int_Type =>
            API.Clear_Named_Framebuffer_Color_Unsigned_Int.Ref
              (Object.Reference.GL_Id, Enums.Color_Buffer, Index, Value);
         when Depth_Type =>
   ...
   begin
      API.Clear_Named_Framebuffer_Depth.Ref
   ...
   begin
      API.Clear_Named_Framebuffer_Stencil.Ref
   ...
   begin
      API.Clear_Named_Framebuffer_Depth_Stencil.Ref
