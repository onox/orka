...
package Test_Real_Tensors_CPU_Singles_Matrices is new Generic_Test_Real_Tensors_Matrices
  ("CPU - Singles",
   AUnit.Test_Cases.Test_Case,
   Orka.Float_32,
   Orka.Numerics.Singles.Tensors,
   Orka.Numerics.Singles.Tensors.CPU.Real_CPU_Tensor,
   Orka.Numerics.Singles.Tensors.CPU.Q,
   Orka.Numerics.Singles.Tensors.CPU.R);
