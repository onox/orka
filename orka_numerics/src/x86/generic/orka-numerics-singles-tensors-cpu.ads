...
package Orka.Numerics.Singles.Tensors.CPU is new Orka.Numerics.Singles.Tensors.SIMD_CPU
  (Integer_32, SIMD.SSE2.Integers.m128i,
   ...
   SIMD.SSE.Singles.Math.Min, SIMD.SSE.Singles.Math.Max,
   SIMD.SSE4_1.Singles.Math.Ceil, SIMD.SSE4_1.Singles.Math.Floor,
   ...
   SIMD.SSE.Singles.Compare."=", SIMD.SSE.Singles.Compare."/=",
   SIMD.SSE.Singles.Compare.">", SIMD.SSE.Singles.Compare."<",
   SIMD.SSE.Singles.Compare.">=", SIMD.SSE.Singles.Compare."<=");
